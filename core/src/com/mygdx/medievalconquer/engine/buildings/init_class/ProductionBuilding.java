...
public class ProductionBuilding extends  Building {
    public boolean start_production = true;
    public long time = this.tools.time();
    public ProductionBuilding(Tools tools, String name, int[] size, int[] pos, int angle, int lvl, int life, String kind, Map<String, Integer> stock, String layer) {
        super(tools, name, size, pos, angle, lvl, life, kind, stock, layer);
    }

    public boolean check_product() {
        Map<String, Integer> prod_max = this.tools.prod_max(this);
        Map<String, Integer> prod_res = this.tools.prod_res(this);
    ...
    public void update() {
        int prod_time = this.tools.prod_time(this);
        Map<String, Integer> prod_res = this.tools.prod_res(this);
